  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <motion.a
        ...
        className="hidden md:flex px-4 py-2 bg-slate-900/80 backdrop-blur-md text-white text-xs font-bold rounded-full border border-white/10 shadow-xl uppercase tracking-wider whitespace-nowrap pointer-events-none group-hover:pointer-events-auto"
      >
        Mulai Diskusi
      </motion.a>
      ...
      >
        ...
        {/* Desktop Tooltip (Handled by CSS/Motion) */}
